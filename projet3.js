...
function nombreEntier(nombreMax)
{
    return Math.floor( Math.random() * Math.floor(nombreMax));
}
...
nouveau.addEventListener('click',() => {
    ...
    do{
        ...
        nombreAleatoire = nombreEntier(citations.length);

    }while(nombreAleatoire == dernier)
    
    //  affiche des citations et auteurs aléatoirement 
